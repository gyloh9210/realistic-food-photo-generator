...
describe('ReferenceGrid', () => {
  ...
  it('shows server decisions in read-only mode without calling onSubmit', async () => {
    const onSubmit = vi.fn()
    const user = userEvent.setup()
    ...
    render(<ReferenceGrid images={reviewed} capped={false} round={0} readOnly onSubmit={onSubmit} />)
